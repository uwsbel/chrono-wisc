...
\note This is the original ray-cast radar: it reports range, bearing and a ground-truth velocity
per ray, and its errors are geometric. For a radar whose errors are radar errors -- misses under a
detection threshold, mirror ghosts, folded velocities, late tracks -- see @ref phys_radar_sensor.
