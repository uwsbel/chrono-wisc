...
#ifndef CHLINKDIR3FRAME_H
#define CHLINKDIR3FRAME_H
...
/// Constraint between the direction of a FEA node of ChNodeFEAxyzDDD class, and a ChBodyFrame (frame).
/// The D direction of the ChNodeFEAxyzDDD is enforced to stay parallel to a given direction associated to the
/// ChBodyFrame.
class ChApi ChLinkNodeSlope3Frame : public ChLinkBase {
  public:
    ChLinkNodeSlope3Frame();
    ChLinkNodeSlope3Frame(const ChLinkNodeSlope3Frame& other);
    ~ChLinkNodeSlope3Frame() {}

    /// "Virtual" copy constructor (covariant return type).
    virtual ChLinkNodeSlope3Frame* Clone() const override { return new ChLinkNodeSlope3Frame(*this); }
    ...
    virtual int Initialize(std::shared_ptr<ChNodeFEAxyzDDD> node,  ///< xyzD node to join (with the direction)
    ...
    virtual std::shared_ptr<ChNodeFEAxyzDDD> GetConstrainedNode() { return m_node; }
  ...
  private:
    ...
    std::shared_ptr<fea::ChNodeFEAxyzDDD> m_node;
