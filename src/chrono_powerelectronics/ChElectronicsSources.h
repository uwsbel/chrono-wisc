...
public:
    ...
    int source_call_counter = 0;    

    ChElectronicsCosimulation* cosim;                           // Contains how many times you called this source
...
public:
    ...
    ChElectronicsSources(ChElectronicsCosimulation* cosim);
