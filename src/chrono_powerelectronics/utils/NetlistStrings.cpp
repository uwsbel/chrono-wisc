...
std::vector<std::string> NetlistStrings::Read_File(std::string File_name)
{
...
void NetlistStrings::Write_File(std::string File_name, std::string File_contents)
{
...
void NetlistStrings::Append_File(std::string File_name, std::string File_contents)
{
    std::ofstream newfile;
...
void NetlistStrings::Dat_File_Vector_double(std::string File_name, std::vector<double> File_contents)
{
...
void NetlistStrings::Dat_File_Vector_Vector_double(std::string File_name, std::vector<std::vector<double>> File_contents)
{
    // Open a file named "data.dat" in binary mode for writing
    std::ofstream outFile(File_name, std::ios::out | std::ios::binary); 
    // Check if the file is successfully opened
...
void NetlistStrings::Save_Vector_double_To_Txt(const std::string& file_name, const std::vector<double>& data) {
...
std::vector<double> NetlistStrings::Read_Txt_File_Into_Vector_double(const std::string& file_name) {
...
void NetlistStrings::Save_Vector_Vector_double_To_Txt(const std::string& file_name, const std::vector<std::vector<double>>& data) {
    std::ofstream outFile(file_name);
    // Check if the file is successfully opened
    if (!outFile) {
        std::cerr << "Error opening the file! " << file_name << std::endl;
...
std::vector<std::vector<double>> NetlistStrings::Read_Txt_File_Into_Vector_Vector_double(const std::string& file_name)
{
...
std::vector<std::string> NetlistStrings::List_Folders_In_Directory(const std::string& directoryPath) {
...
bool NetlistStrings::ContainsPattern(const std::string& str, const std::string& pattern)
{
...
bool NetlistStrings::StrCompare(const std::string& str, const std::string& pattern)
{
...
std::vector<std::string> NetlistStrings::First_Letter_Extractor(std::vector<std::string>& File_contents)
{
...
std::string NetlistStrings::Extract_Before_Pattern(const std::string& input, const std::string& pattern) {
...
std::vector<double> NetlistStrings::Linspace(double x1, double x2, int n) {
...
std::pair<std::vector<std::string>, std::vector<size_t> > NetlistStrings::Sort_With_Indices(const std::vector<std::string>& input)
{
...
std::string NetlistStrings::Replace_Substring(const std::string& str, const std::string& oldStr, const std::string& newStr) {
...
std::vector<std::string> NetlistStrings::To_Lower_Case(const std::vector<std::string>& strings) {
...
void NetlistStrings::Scope_String_Vector(std::vector<std::string>& File_contents)
{
    for (const auto& string_line : File_contents)
    {
...
void NetlistStrings::Scope_size_t_Vector(std::vector<size_t>& File_contents)
{
...
std::vector<std::vector<double>> NetlistStrings::Concatenate_2_Vectors(const std::vector<std::vector<double>>& vector1, const std::vector<std::vector<double>>& vector2)
{
...
std::string NetlistStrings::Num_To_LongEng_String(double number)
{
    std::ostringstream oss;
    oss << std::scientific << std::uppercase << std::setprecision(8) << number;
    std::string result = oss.str();
