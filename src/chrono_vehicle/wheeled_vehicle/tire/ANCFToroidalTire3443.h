...
#ifndef ANCF_TOROIDAL_TIRE_3443_H
#define ANCF_TOROIDAL_TIRE_3443_H
...
class CH_VEHICLE_API ANCFToroidalTire3443 : public ChANCFTire {
  public:
    ANCFToroidalTire3443(const std::string& name);
    ~ANCFToroidalTire3443() {}
