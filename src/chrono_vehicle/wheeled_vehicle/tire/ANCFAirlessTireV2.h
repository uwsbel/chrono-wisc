...
#ifndef ANCF_AIRLESS_TIRE_V2_H
#define ANCF_AIRLESS_TIRE_V2_H
...
class CH_VEHICLE_API ANCFAirlessTireV2 : public ChANCFTire {
  public:
    ANCFAirlessTireV2(const std::string& name);
    ~ANCFAirlessTireV2() {}
    ...
    void SetMidElementTConnection(bool tf) { m_mid_el_spokes = tf; };
