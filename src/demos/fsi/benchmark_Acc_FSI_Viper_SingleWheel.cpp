...
std::string out_dir = GetChronoOutputPath() + "FSI_Viper_Single_Wheel";
...
void CreateSolidPhase(ChSystemSMC& sysMBS,
    ...
    chrono::utils::AddBoxContainer(ground, cmaterial,                                 //
                                   ...
                                   ChVector3d(1.1 * bxDim, 1.2 * byDim, bzDim), 0.1,  //
                                   ChVector3i(2, 2, 2),                               //
                                   false);
    ...
    sysSPH.AddBoxContainerBCE(ground,                                       //
                              ChFrame<>(ChVector3d(0., 0., 0.), QUNIT),     //
                              ChVector3d(1.1 * bxDim, 1.2 * byDim, bzDim),  //
                              ChVector3i(2, 0, -1));
...
int main(int argc, char* argv[]) {
    ...
    ChVector3d cMin(-(1.1 * bxDim) / 2 - 4 * iniSpacing, -(1.1 * byDim) / 2, -bzDim - 30 * iniSpacing);
    ChVector3d cMax((1.1 * bxDim) / 2 + 4 * iniSpacing, (1.1 * byDim) / 2, bzDim + 30 * iniSpacing);
