...
int main(int argc, char* argv[]) {
    ...
    if (!GetProblemSpecs(argc, argv, t_end, ps_freq, boundary_type, viscosity_type, d0_multiplier, scale)) {
        return 1;
    }
    ...
    // Create container
    fsi.AddBoxContainer(scaled_csize, ChVector3d(0, 0, 0), BoxSide::Z_NEG);
