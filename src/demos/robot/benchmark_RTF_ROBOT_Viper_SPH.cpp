...
int main(int argc, char* argv[]) {
    ...
    ChVector3d cMin(-bxDim / 2 - 3 * initSpacing, -byDim / 2 - 0.5 * initSpacing, -bzDim * 10);
    ChVector3d cMax(bxDim / 2 + 3 * initSpacing, byDim / 2 + 0.5 * initSpacing, bzDim * 10);
    ...
    if (render) {
        ...
        visVSG->SetWindowTitle("Viper on CRM terrain");
