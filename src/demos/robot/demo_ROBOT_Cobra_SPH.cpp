...
// Enable/disable saving snapshots during visualization
bool snapshots = true;
int snapshot_fps = 10;
...
std::string wheel_obj = "robot/cobra/obj/cobra_simplewheel.obj";
...
int main(int argc, char* argv[]) {
    ...
    if (argc == 2) {
        ...
        std::cout << "usage: ./demo_ROBOT_Cobra_SPH <json_file>" << std::endl;
        return 1;
    }
    ...
    if (render) {
        ...
        visFSI->SetTitle("Cobra on CRM terrain");
    ...
    unsigned int snapshot_steps = (unsigned int)round(1 / (snapshot_fps * dT));
    double time = 0.0;
    int current_step = 0;
