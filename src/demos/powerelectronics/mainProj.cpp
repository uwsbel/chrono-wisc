...
int main(int argc, char* argv[]) {
    ...
    */
    ...
    std::string NETLIST_name = "SPICE_circuit/Models/Circuit_Netlist.cir";
    std::string INPUT_name = "SPICE_circuit/Models/INPUT_Netlist.txt";
    std::string OUTPUT_name = "SPICE_circuit/Models/OUTPUT_Netlist.txt";
    std::string PWL_sources_name = "SPICE_circuit/Models/PWL_sources.txt";
    std::string Param_IC_name = "SPICE_circuit/Models/Param_IC.txt";
    std::string Python_simulator_name = "MainPython_Spice_1";

    // ======== Initialize the NETLIST for the co-simulation ======== 
    ChElectronicsExecutor Circuit1(NETLIST_name, INPUT_name, OUTPUT_name, PWL_sources_name, Param_IC_name, Python_simulator_name);
    ...
    while (t_sim_mechanics < t_simulation_STOP && brake_flag == 1) {
        ...
        sleep(300.0e-3); // Wait until Python circuit solution is completed
