...
# === Step 6: Sort by worst (highest) metrics ===
...
print("\nBottom 10 Worst (Highest) Composite Metrics and Corresponding Parameters:")
...
output_path = folder + "/bottom_10_worst_metrics.csv"
