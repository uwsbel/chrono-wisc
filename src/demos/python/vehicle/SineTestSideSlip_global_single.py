...
def main():
    ...
    for idx in remaining_indices:
        ...
        try:
            ...
            print(
                f"Trial {idx}: metric={metric:.4f}, time={total_time_to_reach:.4f}s, rms={rms_error:.4f}m, power={average_power:.2f}W, beta_rms={beta_rms:.4f}rad"
            )
