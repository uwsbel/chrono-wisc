...
def _worker_run_trial(trial_index, param_dict, particle_spacing, assigned_gpu, failed_log):
    ...
    try:
        ...
        from SlalomTest_sim import sim  # noqa: WPS433 (intentional local import)
...
def main():
    ...
    parser.add_argument("--out_dir", type=str, default=os.path.join(os.getcwd(), "ARTcar_SlalomTest_BO"), help="Output directory for logs and state")
