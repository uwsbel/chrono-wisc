...
def sim(Params, weight_speed=0.5, weight_power=0.25, slalom_y=0.2, num_samples=200, snapshot_dir=None):
    ...
    # Normalize power (assuming reasonable power range 0-100W, penalize high power)
