...
// The linear velocity is controlled via torque using a simple PID controller
//
// =============================================================================
...
int main(int argc, char* argv[]) {
    ...
    timer.stop();
    step_time = timer();
    std::cout << std::endl << "Simulation completed. t: " << time << " seconds" << std::endl;
    WriteSimStats(std::cout, spindle_body);
    WriteSimStats(logfile, spindle_body);
