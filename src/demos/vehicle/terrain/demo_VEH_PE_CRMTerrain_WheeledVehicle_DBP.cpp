...
int main(int argc, char* argv[]) {
    ...
    while (time < tend) {
        ...
        double engine_torque2 = hm2->GetOutputMotorshaftTorque();
        double engine_torque3 = hm3->GetOutputMotorshaftTorque();
        double engine_torque4 = hm4->GetOutputMotorshaftTorque();
