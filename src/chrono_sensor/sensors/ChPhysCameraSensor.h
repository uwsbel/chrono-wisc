...
class CH_SENSOR_API ChPhysCameraSensor : public ChOptixSensor {
	public:
		...
		/// @param use_gi Enable the global illumination, with significant decrease in performace. Notice that denoiseAlpha
		/// in denoiser should be OPTIX_DENOISER_ALPHA_MODE_COPY, since the alpha channel is used as distance channel in this
		/// sensor class.
		...
		ChPhysCameraSensor(
			...
			bool use_gi = false,											// whether to use global illumination
