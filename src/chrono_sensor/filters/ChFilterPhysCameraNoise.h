...
class CH_SENSOR_API ChFilterPhysCameraNoise : public ChFilter {
	public:
		...
		/// @param dark_current_vec ChVector of temporal means of dark currents, [electrons/sec]
	...
	private:
		...
		float m_dark_currents[3];					// temporal mean of dark currents, [electrons/sec]
		float m_noise_gains[3];						// temporal noise gains, [1/1]
