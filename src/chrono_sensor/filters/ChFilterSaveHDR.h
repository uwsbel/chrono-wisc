...
#ifndef CHFILTERSAVEHDR_H
#define CHFILTERSAVEHDR_H
...
class CH_SENSOR_API ChFilterSaveHDR : public ChFilter {
  public:
    /// Class constructor
    /// @param data_path The path to save the data
    /// @param name the name of the filter
    ChFilterSaveHDR(std::string data_path = "", std::string name = "ChFilterSaveHDR");

    /// Class destructor
    virtual ~ChFilterSaveHDR() {}
